...
func NewExampleAPI(spec *loads.Document) *ExampleAPI {
	return &ExampleAPI{
		...
		UserMyselfHandler: user.MyselfHandlerFunc(func(params user.MyselfParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation user.Myself has not yet been implemented")
		}),

		// Applies when the "Cookie" header is set
		SessionSecurityAuth: func(token string) (interface{}, error) {
...
/*ExampleAPI Example application server */
type ExampleAPI struct {
	...
	// SessionSecurityAuth registers a function that takes a token and returns a principal
	// it performs authentication based on an api key Cookie provided in the header
	SessionSecurityAuth func(string) (interface{}, error)
	...
	// UserMyselfHandler sets the operation handler for the myself operation
	UserMyselfHandler user.MyselfHandler
...
func (o *ExampleAPI) Validate() error {
	...
	if o.UserMyselfHandler == nil {
		unregistered = append(unregistered, "user.MyselfHandler")
	}
...
func (o *ExampleAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	...
	for name := range schemes {
		...
		case "SessionSecurity":
			scheme := schemes[name]
			result[name] = o.APIKeyAuthenticator(scheme.Name, scheme.In, o.SessionSecurityAuth)
...
func (o *ExampleAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/api/auth/login"] = auth.NewLogin(o.context, o.AuthLoginHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/api/auth/logout"] = auth.NewLogout(o.context, o.AuthLogoutHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/api/user/myself"] = user.NewMyself(o.context, o.UserMyselfHandler)
}
